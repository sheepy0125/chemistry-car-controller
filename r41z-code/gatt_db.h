...
PRIMARY_SERVICE(service_gap, gBleSig_GenericAccessProfile_d)
    ...
    CHARACTERISTIC(char_appearance, gBleSig_GapAppearance_d, (gGattCharPropRead_c) )
		...
		/* #define XDECL_VALUE(name, uuid, permissions, size, ...)
				VALUE_DECL(name, (size), (uuid), (permissions) )
...
PRIMARY_SERVICE_UUID128(service_wireless_uart, uuid_service_wireless_uart)
	...
	CHARACTERISTIC_UUID128(char_uart_notify_stream, uuid_uart_notify_stream, (gGattCharPropRead_c))
		VALUE_UUID128_VARLEN(value_uart_notify_stream, uuid_uart_notify_stream, (gPermissionFlagReadable_c), 0xF4, 0x00)
