...
If an error occurred, then an `ErrorResponse` will be sent, consisting of an error enum variant (`unsigned integer`) and an error message (`string`).
